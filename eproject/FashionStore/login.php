            ...
            <div class="login-form-wrapper">
              ...
              <form  action="code.php" method="post">
                <div class="mb-4">
                  ...
                  <input type="email" name="useremail" class="form-control" id="email" placeholder="Enter your email" required="" autocomplete="email">
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="password" name="userpass" class="form-control" id="password" placeholder="Enter your password" required="" autocomplete="current-password">
                </div>
