...
<table  class="table table-hover">
  ...
  $fetchquery=mysqli_query($connection,"select * from newarrival");
  foreach($fetchquery as $data1){
    ?>
 <tr>
      <th scope="row"><?php echo $data1['id']?></th>
      <td><?php echo $data1['arrivname']?></td>
      <td><img src="../assets/img/categories/<?php echo $data1['arrivimg']?>" alt="not found" height="100px" width="100px"></td>
      <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="deletearriv" class="btn btn-danger">Delete</button>
        </form>
      </div>
    </div>
  </div>
