...
<table class="table">
  ...
  <tbody>
    <?php
    $fetchquery=mysqli_query($connection,"select * from employees");
  ...
  <div class="modal-dialog">
    ...
    <form action="../code.php" method="post">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" name="delete_e" class="btn btn-danger">Delete</button>
...
<div class="modal fade" id="Update<?php echo $data['id']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="../code.php" method="post">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" name="update_e" class="btn btn-success">Update</button>
