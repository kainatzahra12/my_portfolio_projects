...
?>
  ...
  <main class="main">
    ...
    <!-- Product Details Section -->
     <?php
		if(isset($_GET['id'])){
				$demdetail=mysqli_query($connection,"select * from demandingpro where demid='".$_GET['id']."'");
    $data=mysqli_fetch_assoc($demdetail);
?>
            ...
            <div class="product-gallery">
              ...
              <div class="thumbnails-vertical">
                <div class="thumbnails-container">
                  <div class="thumbnail-item active" data-image="assets/img/categories/<?php echo$data ['demimg']?>">
                    <img src="assets/img/categories/<?php echo$data ['demimg']?>" alt="Product Thumbnail" class="img-fluid">
                  </div>
              ...
              <div class="main-image-wrapper">
                <div class="image-zoom-container">
                  <a href="assets/img/categories/<?php echo $data['demimg']?>" class="glightbox" data-gallery="product-gallery">
                    <img src="assets/img/categories/<?php echo $data['demimg']?>" alt="Product Image" class="img-fluid main-image drift-zoom" id="main-product-image" data-zoom="assets/img/categories/<?php echo $data['demimg']?>">
            ...
            <div class="product-info-wrapper" id="product-info-sticky">
              ...
              <div class="product-meta">
                <div class="d-flex justify-content-between align-items-center mb-3">
                  <span class="product-category"><?php echo $data['demname']?></span>
                ...
                <h1 class="product-title"><?php echo $data['demdetail']?></h1>


              <!-- Product Price -->
              <div class="product-price-container">
                <div class="price-wrapper">
                  <span class="current-price">$<?php echo $data['demprice']?></span>
             ...
             <!-- Action Buttons -->
              <div class="product-actions">
                ...
                <?php
									...
									?>
       <a href="login.php"><button class="btn btn-primary add-to-cart-btn">
